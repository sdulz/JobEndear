...
class Algorithm  {
      ...
      //Apply TextRank
        ...
        final List<Sentence> sentenceObjects = sentences.map((sentence) => Sentence(sentences.indexOf(sentence), sentence.split(' '))).toList();
        ...
        final ranking = graph.pageRank();
          ...
          final collection = firestore.collection('projects').doc(projectId).collection('models').doc(modelName).collection('summaries');
